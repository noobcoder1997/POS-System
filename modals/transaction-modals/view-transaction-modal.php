        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="item_name" placeholder="item name" value="<?php echo ($stock['status'] == 0) ? "Sold" : (($stock['status'] == 1) ? "Defective" : (($stock['status'] == 2) ? "Expired" : (($stock['status'] == 3) ? "Damaged" : "In-Stock"))); ?>" disabled>
                        <label for="item_name">Status</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="item_name" placeholder="item name" value="<?php echo ($stock['product_return']==0)? "No":"Yes"; ?>" disabled>
                        <label for="item_name">Product Return</label>
                    </div>
                </form>
                <br>
            </div>
